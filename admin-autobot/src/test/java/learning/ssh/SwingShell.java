 ...
 * fingerprints of server hostkeys - Adding a server hostkey to a known_hosts
 * file (+hashing the hostname for security) - Authentication with DSA, RSA,
 * password and keyboard-interactive methods
 *
 */
